...
<head>
        <meta charset="UTF-8" />
        <title>My Ideas - My Digital Diary</title>
                    ...
                    <div class="lg:w-3/4 md:w-2/3 md:px-3 mt-[30px] md:mt-0">
                        <div class="grid lg:grid-cols-2j grid-cols-1 gap-[30px]">
                            <div class="mt-[30px] lg:mt-0">
                                <h5 class="text-xl font-semibold">My Ideas</h5>

                                <?php                   
 $Quedybbrbo="SELECT * FROM activities WHERE type='Idea' AND userid='$naid' ORDER BY id DESC ";
 ...
 <div>
         <a href='del-idea.php?id=$evid' class='btn btn-icon bg-red-600/5 hover:bg-red-600 border-red-600/10 hover:border-red-600 text-red-600 hover:text-white rounded-full'><i data-feather='trash-2' class='h-4 w-4'></i></a>
 </div>
</div>
